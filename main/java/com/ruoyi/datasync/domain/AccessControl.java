...
public class AccessControl extends BaseEntity
{
    ...
    /** 控制层级 */
    @Excel(name = "控制层级")
    private String operationalLayer;
    ...
    public void setOperationalLayer(String operationalLayer) 
    {
        this.operationalLayer = operationalLayer;
    }

    public String getOperationalLayer() 
    {
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("operationalLayer", getOperationalLayer())
            .append("operationalMode", getOperationalMode())
