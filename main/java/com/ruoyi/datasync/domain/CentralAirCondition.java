...
/**
 * 中央空调对象 central_air_condition
 * 
 * @author ruoyi
 * @date 2021-04-18
 */
public class CentralAirCondition extends BaseEntity
{
    ...
    /** 中央空调分类 */
    @Excel(name = "中央空调分类")
    private String centralAirConditioningType;
    ...
    /** 空调制冷量 */
    @Excel(name = "空调制冷量")
    private Integer refrigeratingCapacity;
    ...
    public void setCentralAirConditioningType(String centralAirConditioningType) 
    {
        this.centralAirConditioningType = centralAirConditioningType;
    }

    public String getCentralAirConditioningType() 
    {
        return centralAirConditioningType;
    }
    ...
    public void setRefrigeratingCapacity(Integer refrigeratingCapacity) 
    {
        this.refrigeratingCapacity = refrigeratingCapacity;
    }

    public Integer getRefrigeratingCapacity() 
    {
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("centralAirConditioningType", getCentralAirConditioningType())
            ...
            .append("refrigeratingCapacity", getRefrigeratingCapacity())
