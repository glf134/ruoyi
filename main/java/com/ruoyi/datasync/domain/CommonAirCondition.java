...
/**
 * 普通空调对象 common_air_condition
 * 
 * @author ruoyi
 * @date 2021-04-18
 */
public class CommonAirCondition extends BaseEntity
{
    ...
    /** 普通空调分类 */
    @Excel(name = "普通空调分类")
    private String classificationOfGeneralAirConditioning;
    ...
    public void setClassificationOfGeneralAirConditioning(String classificationOfGeneralAirConditioning) 
    {
        this.classificationOfGeneralAirConditioning = classificationOfGeneralAirConditioning;
    }

    public String getClassificationOfGeneralAirConditioning() 
    {
        return classificationOfGeneralAirConditioning;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("classificationOfGeneralAirConditioning", getClassificationOfGeneralAirConditioning())
