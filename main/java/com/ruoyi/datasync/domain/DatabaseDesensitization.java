...
/**
 * 数据库脱敏对象 database_desensitization
 * 
 * @author ruoyi
 * @date 2021-04-18
 */
public class DatabaseDesensitization extends BaseEntity
{
    ...
    /** 功能支持 */
    @Excel(name = "功能支持")
    private String functionSupported;
    ...
    /** 规则支持 */
    @Excel(name = "规则支持")
    private String regulationSupported;
    ...
    public void setFunctionSupported(String functionSupported) 
    {
        this.functionSupported = functionSupported;
    }

    public String getFunctionSupported() 
    {
    ...
    public void setRegulationSupported(String regulationSupported) 
    {
        this.regulationSupported = regulationSupported;
    }

    public String getRegulationSupported() 
    {
        return regulationSupported;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("functionSupported", getFunctionSupported())
            ...
            .append("regulationSupported", getRegulationSupported())
