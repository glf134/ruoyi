...
/**
 * 门禁系统对象 entrance_guard
 * 
 * @author ruoyi
 * @date 2021-04-18
 */
public class EntranceGuard extends BaseEntity
{
    ...
    /** 门禁系统 */
    @Excel(name = "门禁系统")
    private String entranceGuardSystem;
    ...
    public void setDataSaveCycle(String dataSaveCycle) 
    {
        this.dataSaveCycle = dataSaveCycle;
    }

    public String getDataSaveCycle() 
    {
        return dataSaveCycle;
    }
    ...
    public void setEntranceGuardSystem(String entranceGuardSystem) 
    {
        this.entranceGuardSystem = entranceGuardSystem;
    }

    public String getEntranceGuardSystem() 
    {
        return entranceGuardSystem;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            .append("id", getId())
            .append("accessControlType", getAccessControlType())
            ...
            .append("dataSaveCycle", getDataSaveCycle())
            ...
            .append("entranceGuardSystem", getEntranceGuardSystem())
