...
/**
 * 光纤交换机对象 fiber_switch
 * 
 * @author ruoyi
 * @date 2021-04-18
 */
public class FiberSwitch extends BaseEntity
{
    ...
    /** 光纤端口数量 */
    @Excel(name = "光纤端口数量")
    private Integer numberOfOpticalFiberPorts;
    ...
    public void setNumberOfOpticalFiberPorts(Integer numberOfOpticalFiberPorts) 
    {
        this.numberOfOpticalFiberPorts = numberOfOpticalFiberPorts;
    }

    public Integer getNumberOfOpticalFiberPorts() 
    {
        return numberOfOpticalFiberPorts;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("numberOfOpticalFiberPorts", getNumberOfOpticalFiberPorts())
