...
/**
 * 消防系统对象 fire_protection
 * 
 * @author ruoyi
 * @date 2021-04-18
 */
public class FireProtection extends BaseEntity
{
    ...
    /** 消防排烟系统 */
    @Excel(name = "消防排烟系统")
    private String fireExhaustSystem;

    /** 气体灭火系统 */
    @Excel(name = "气体灭火系统")
    private String gasExhaustSystem;
    ...
    /** 极早期烟感探测系统 */
    @Excel(name = "极早期烟感探测系统")
    private String smokeDetectionSystem;
    ...
    /** 细水雾灭火系统 */
    @Excel(name = "细水雾灭火系统")
    private String waterExhaustSystem;
    ...
    public void setFireExhaustSystem(String fireExhaustSystem) 
    {
        this.fireExhaustSystem = fireExhaustSystem;
    }

    public String getFireExhaustSystem() 
    {
        return fireExhaustSystem;
    }
    public void setGasExhaustSystem(String gasExhaustSystem) 
    {
        this.gasExhaustSystem = gasExhaustSystem;
    }

    public String getGasExhaustSystem() 
    {
        return gasExhaustSystem;
    }
    ...
    public void setSmokeDetectionSystem(String smokeDetectionSystem) 
    {
        this.smokeDetectionSystem = smokeDetectionSystem;
    }

    public String getSmokeDetectionSystem() 
    {
        return smokeDetectionSystem;
    }
    ...
    public void setWaterExhaustSystem(String waterExhaustSystem) 
    {
        this.waterExhaustSystem = waterExhaustSystem;
    }

    public String getWaterExhaustSystem() 
    {
        return waterExhaustSystem;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("fireAlarmSystem", getFireAlarmSystem())
            .append("fireExhaustSystem", getFireExhaustSystem())
            .append("gasExhaustSystem", getGasExhaustSystem())
            ...
            .append("otherSystems", getOtherSystems())
            ...
            .append("smokeDetectionSystem", getSmokeDetectionSystem())
            .append("sprinklerSystem", getSprinklerSystem())
            .append("waterExhaustSystem", getWaterExhaustSystem())
