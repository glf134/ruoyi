 ...
 * @date 2021-04-18
 */
public class Firewall extends BaseEntity
{
    ...
    /** 支持Bypass功能 */
    @Excel(name = "支持Bypass功能")
    private Long bypassFunction;
    ...
    /** IPv6基础协议 */
    @Excel(name = "IPv6基础协议")
    private String ipv6BasicProtocol;
    ...
    /** 最大新建连接速率 */
    @Excel(name = "最大新建连接速率")
    private Integer maximumNewConnectionRate;

    /** 最大并发连接数 */
    @Excel(name = "最大并发连接数")
    private Integer maximumNumberOfConcurrentConnections;

    /** 网络安全能力 */
    @Excel(name = "网络安全能力")
    private String networkSecurityCapability;
    ...
    public void setBypassFunction(Long bypassFunction) 
    {
        this.bypassFunction = bypassFunction;
    }

    public Long getBypassFunction() 
    {
    ...
    public void setHandlingCapacity(Integer handlingCapacity) 
    {
        this.handlingCapacity = handlingCapacity;
    }

    public Integer getHandlingCapacity() 
    {
    ...
    public void setIpv6BasicProtocol(String ipv6BasicProtocol) 
    {
        this.ipv6BasicProtocol = ipv6BasicProtocol;
    }

    public String getIpv6BasicProtocol() 
    {
        return ipv6BasicProtocol;
    }
    ...
    public void setMaximumNewConnectionRate(Integer maximumNewConnectionRate) 
    {
        this.maximumNewConnectionRate = maximumNewConnectionRate;
    }

    public Integer getMaximumNewConnectionRate() 
    {
        return maximumNewConnectionRate;
    }
    public void setMaximumNumberOfConcurrentConnections(Integer maximumNumberOfConcurrentConnections) 
    {
        this.maximumNumberOfConcurrentConnections = maximumNumberOfConcurrentConnections;
    }

    public Integer getMaximumNumberOfConcurrentConnections() 
    {
        return maximumNumberOfConcurrentConnections;
    }
    public void setNetworkSecurityCapability(String networkSecurityCapability) 
    {
        this.networkSecurityCapability = networkSecurityCapability;
    }

    public String getNetworkSecurityCapability() 
    {
        return networkSecurityCapability;
    }
    ...
    public void setWirelessFunction(Long wirelessFunction) 
    {
        this.wirelessFunction = wirelessFunction;
    }

    public Long getWirelessFunction() 
    {
        return wirelessFunction;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("bypassFunction", getBypassFunction())
            ...
            .append("deploymentMode", getDeploymentMode())
            ...
            .append("handlingCapacity", getHandlingCapacity())
            .append("influenceSystem", getInfluenceSystem())
            .append("ipv6BasicProtocol", getIpv6BasicProtocol())
            ...
            .append("maximumNewConnectionRate", getMaximumNewConnectionRate())
            .append("maximumNumberOfConcurrentConnections", getMaximumNumberOfConcurrentConnections())
            .append("networkSecurityCapability", getNetworkSecurityCapability())
            .append("numberOfCards", getNumberOfCards())
            ...
            .append("securityFunction", getSecurityFunction())
            ...
            .append("wirelessFunction", getWirelessFunction())
