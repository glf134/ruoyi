...
/**
 * 流量分析设备对象 flow_analysis
 * 
 * @author ruoyi
 * @date 2021-04-18
 */
public class FlowAnalysis extends BaseEntity
{
    ...
    public void setAnalysisLayer(String analysisLayer) 
    {
    ...
    public void setHddCapability(Integer hddCapability) 
    {
        this.hddCapability = hddCapability;
    }

    public Integer getHddCapability() 
    {
        return hddCapability;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("analysisLayer", getAnalysisLayer())
            ...
            .append("hddCapability", getHddCapability())
