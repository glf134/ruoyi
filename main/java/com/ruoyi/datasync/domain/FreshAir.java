 ...
 * @date 2021-04-18
 */
public class FreshAir extends BaseEntity
{
    ...
    /** 新风过滤级别 */
    @Excel(name = "新风过滤级别")
    private String freshAirFiltrationLevel;

    /** 新风量 */
    @Excel(name = "新风量")
    private Integer freshAirRate;
    ...
    /** 新风过滤器性能 */
    @Excel(name = "新风过滤器性能")
    private String performanceOfFreshAirFilter;
    ...
    public void setFreshAirFiltrationLevel(String freshAirFiltrationLevel) 
    {
        this.freshAirFiltrationLevel = freshAirFiltrationLevel;
    }

    public String getFreshAirFiltrationLevel() 
    {
        return freshAirFiltrationLevel;
    }
    public void setFreshAirRate(Integer freshAirRate) 
    {
        this.freshAirRate = freshAirRate;
    }

    public Integer getFreshAirRate() 
    {
        return freshAirRate;
    }
    ...
    public void setPerformanceOfFreshAirFilter(String performanceOfFreshAirFilter) 
    {
        this.performanceOfFreshAirFilter = performanceOfFreshAirFilter;
    }

    public String getPerformanceOfFreshAirFilter() 
    {
        return performanceOfFreshAirFilter;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("freshAirFiltrationLevel", getFreshAirFiltrationLevel())
            .append("freshAirRate", getFreshAirRate())
            ...
            .append("performanceOfFreshAirFilter", getPerformanceOfFreshAirFilter())
