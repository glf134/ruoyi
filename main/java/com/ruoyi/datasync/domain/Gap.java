...
/**
 * 安全隔离网闸数据元（GAP）对象 gap
 * 
 * @author ruoyi
 * @date 2021-04-18
 */
public class Gap extends BaseEntity
{
    ...
    /** 网闸类型 */
    @Excel(name = "网闸类型")
    private String categoryOfGatekeeper;

    /** 数据交换速率 */
    @Excel(name = "数据交换速率")
    private Integer dataExchangeRate;
    ...
    /** 硬件切换时间 */
    @Excel(name = "硬件切换时间")
    private Integer hardwareSwitchingTime;
    ...
    public void setCategoryOfGatekeeper(String categoryOfGatekeeper) 
    {
        this.categoryOfGatekeeper = categoryOfGatekeeper;
    }

    public String getCategoryOfGatekeeper() 
    {
        return categoryOfGatekeeper;
    }
    public void setDataExchangeRate(Integer dataExchangeRate) 
    {
        this.dataExchangeRate = dataExchangeRate;
    }

    public Integer getDataExchangeRate() 
    {
    ...
    public void setHardwareSwitchingTime(Integer hardwareSwitchingTime) 
    {
        this.hardwareSwitchingTime = hardwareSwitchingTime;
    }

    public Integer getHardwareSwitchingTime() 
    {
        return hardwareSwitchingTime;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("categoryOfGatekeeper", getCategoryOfGatekeeper())
            .append("dataExchangeRate", getDataExchangeRate())
            .append("dataSynchronization", getDataSynchronization())
            ...
            .append("hardwareSwitchingTime", getHardwareSwitchingTime())
