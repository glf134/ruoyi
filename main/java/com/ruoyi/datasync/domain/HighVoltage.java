...
/**
 * 高压配电设备对象 high_voltage
 * 
 * @author ruoyi
 * @date 2021-04-18
 */
public class HighVoltage extends BaseEntity
{
    ...
    /** 高压成套配电设备类型 */
    @Excel(name = "高压成套配电设备类型")
    private String typesOfHighVoltageEquipment;
    ...
    public void setTypesOfHighVoltageEquipment(String typesOfHighVoltageEquipment) 
    {
        this.typesOfHighVoltageEquipment = typesOfHighVoltageEquipment;
    }

    public String getTypesOfHighVoltageEquipment() 
    {
        return typesOfHighVoltageEquipment;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("typesOfHighVoltageEquipment", getTypesOfHighVoltageEquipment())
