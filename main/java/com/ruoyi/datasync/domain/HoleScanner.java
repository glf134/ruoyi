...
/**
 * 漏洞扫描设备对象 hole_scanner
 * 
 * @author ruoyi
 * @date 2021-04-18
 */
public class HoleScanner extends BaseEntity
{
    ...
    /** 扫描类别 */
    @Excel(name = "扫描类别")
    private String categoriesOfVulnerabilityScanning;
    ...
    public void setCategoriesOfVulnerabilityScanning(String categoriesOfVulnerabilityScanning) 
    {
        this.categoriesOfVulnerabilityScanning = categoriesOfVulnerabilityScanning;
    }

    public String getCategoriesOfVulnerabilityScanning() 
    {
        return categoriesOfVulnerabilityScanning;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("categoriesOfVulnerabilityScanning", getCategoriesOfVulnerabilityScanning())
