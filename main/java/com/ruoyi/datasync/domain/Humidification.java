...
/**
 * 加湿系统对象 humidification
 * 
 * @author ruoyi
 * @date 2021-04-18
 */
public class Humidification extends BaseEntity
{
    ...
    /** 加湿器分类 */
    @Excel(name = "加湿器分类")
    private String classificationOfHumidifiers;
    ...
    public void setClassificationOfHumidifiers(String classificationOfHumidifiers) 
    {
        this.classificationOfHumidifiers = classificationOfHumidifiers;
    }

    public String getClassificationOfHumidifiers() 
    {
        return classificationOfHumidifiers;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("classificationOfHumidifiers", getClassificationOfHumidifiers())
