...
/**
 * 入侵检测与防御设备（IDS/IPS）对象 ids_ips
 * 
 * @author ruoyi
 * @date 2021-04-18
 */
public class IdsIps extends BaseEntity
{
    ...
    /** 设备类型 */
    @Excel(name = "设备类型")
    private String categoryOfEquipment;
    ...
    public void setCategoryOfEquipment(String categoryOfEquipment) 
    {
        this.categoryOfEquipment = categoryOfEquipment;
    }

    public String getCategoryOfEquipment() 
    {
        return categoryOfEquipment;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("categoryOfEquipment", getCategoryOfEquipment())
