...
/**
 * 一体化机柜对象 integrated_cabinet
 * 
 * @author ruoyi
 * @date 2021-04-18
 */
public class IntegratedCabinet extends BaseEntity
{
    ...
    /** 集成功能 */
    @Excel(name = "集成功能")
    private String integrationFunction;
    ...
    public void setIntegrationFunction(String integrationFunction) 
    {
        this.integrationFunction = integrationFunction;
    }

    public String getIntegrationFunction() 
    {
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("integrationFunction", getIntegrationFunction())
