...
/**
 * 入侵报警系统对象 intrusion_alarm
 * 
 * @author ruoyi
 * @date 2021-04-18
 */
public class IntrusionAlarm extends BaseEntity
{
    ...
    /** 入侵报警系统 */
    @Excel(name = "入侵报警系统")
    private String intrusionAlarmSystem;
    ...
    public void setIntrusionAlarmSystem(String intrusionAlarmSystem) 
    {
        this.intrusionAlarmSystem = intrusionAlarmSystem;
    }

    public String getIntrusionAlarmSystem() 
    {
        return intrusionAlarmSystem;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("intrusionAlarmSystem", getIntrusionAlarmSystem())
