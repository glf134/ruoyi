 ...
 * @date 2021-04-18
 */
public class LowVoltage extends BaseEntity
{
    ...
    /** 低压配电设备控制类型 */
    @Excel(name = "低压配电设备控制类型")
    private String lowVoltageEquipmentControlType;

    /** 低压成套设备类型 */
    @Excel(name = "低压成套设备类型")
    private String lowVoltageEquipmentType;
    ...
    public void setLowVoltageEquipmentControlType(String lowVoltageEquipmentControlType) 
    {
        this.lowVoltageEquipmentControlType = lowVoltageEquipmentControlType;
    }

    public String getLowVoltageEquipmentControlType() 
    {
        return lowVoltageEquipmentControlType;
    }
    public void setLowVoltageEquipmentType(String lowVoltageEquipmentType) 
    {
        this.lowVoltageEquipmentType = lowVoltageEquipmentType;
    }

    public String getLowVoltageEquipmentType() 
    {
        return lowVoltageEquipmentType;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("lowVoltageEquipmentControlType", getLowVoltageEquipmentControlType())
            .append("lowVoltageEquipmentType", getLowVoltageEquipmentType())
