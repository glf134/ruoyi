...
/**
 * 邮件安全过滤系统对象 mail_filtering
 * 
 * @author ruoyi
 * @date 2021-04-18
 */
public class MailFiltering extends BaseEntity
{
    ...
    /** 邮件类型 */
    @Excel(name = "邮件类型")
    private String categoryOfMail;

    /** 恶意邮件类型 */
    @Excel(name = "恶意邮件类型")
    private String categoryOfMaliousEmail;
    ...
    public void setCategoryOfMail(String categoryOfMail) 
    {
        this.categoryOfMail = categoryOfMail;
    }

    public String getCategoryOfMail() 
    {
        return categoryOfMail;
    }
    public void setCategoryOfMaliousEmail(String categoryOfMaliousEmail) 
    {
        this.categoryOfMaliousEmail = categoryOfMaliousEmail;
    }

    public String getCategoryOfMaliousEmail() 
    {
        return categoryOfMaliousEmail;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("categoryOfMail", getCategoryOfMail())
            .append("categoryOfMaliousEmail", getCategoryOfMaliousEmail())
