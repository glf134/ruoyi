...
/**
 * 网络数据防泄漏系统对象 network_data_prevention
 * 
 * @author ruoyi
 * @date 2021-04-18
 */
public class NetworkDataPrevention extends BaseEntity
{
    ...
    /** 内容识别 */
    @Excel(name = "内容识别")
    private String identifiableContent;

    /** 文件识别 */
    @Excel(name = "文件识别")
    private String identifiableFile;
    ...
    /** 协议识别 */
    @Excel(name = "协议识别")
    private String protocolRecognition;
    ...
    public void setIdentifiableContent(String identifiableContent) 
    {
        this.identifiableContent = identifiableContent;
    }

    public String getIdentifiableContent() 
    {
        return identifiableContent;
    }
    public void setIdentifiableFile(String identifiableFile) 
    {
        this.identifiableFile = identifiableFile;
    }

    public String getIdentifiableFile() 
    {
        return identifiableFile;
    }
    ...
    public void setProtocolRecognition(String protocolRecognition) 
    {
        this.protocolRecognition = protocolRecognition;
    }

    public String getProtocolRecognition() 
    {
        return protocolRecognition;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("identifiableContent", getIdentifiableContent())
            .append("identifiableFile", getIdentifiableFile())
            ...
            .append("protocolRecognition", getProtocolRecognition())
