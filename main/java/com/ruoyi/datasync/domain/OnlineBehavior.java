...
/**
 * 上网行为管理设备对象 online_behavior
 * 
 * @author ruoyi
 * @date 2021-04-18
 */
public class OnlineBehavior extends BaseEntity
{
    ...
    /** 支持的功能 */
    @Excel(name = "支持的功能")
    private String supportFunciton;
    ...
    public void setSupportFunciton(String supportFunciton) 
    {
        this.supportFunciton = supportFunciton;
    }

    public String getSupportFunciton() 
    {
        return supportFunciton;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("authenticationPattern", getAuthenticationPattern())
            .append("belongCabinet", getBelongCabinet())
            .append("brandLand", getBrandLand())
            .append("bypass", getBypass())
            ...
            .append("supportFunciton", getSupportFunciton())
