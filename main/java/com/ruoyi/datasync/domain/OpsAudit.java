 ...
 * @date 2021-04-18
 */
public class OpsAudit extends BaseEntity
{
    ...
    /** 存储周期 */
    @Excel(name = "存储周期")
    private Integer dataSavePeriod;
    ...
    public void setContentOfAudit(String contentOfAudit) 
    {
        this.contentOfAudit = contentOfAudit;
    }

    public String getContentOfAudit() 
    {
        return contentOfAudit;
    }
    ...
    public void setDataSavePeriod(Integer dataSavePeriod) 
    {
        this.dataSavePeriod = dataSavePeriod;
    }

    public Integer getDataSavePeriod() 
    {
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("contentOfAudit", getContentOfAudit())
            .append("dataSave", getDataSave())
            ...
            .append("identificationPattern", getIdentificationPattern())
