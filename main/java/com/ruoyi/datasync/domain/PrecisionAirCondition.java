...
/**
 * 精密空调对象 precision_air_condition
 * 
 * @author ruoyi
 * @date 2021-04-18
 */
public class PrecisionAirCondition extends BaseEntity
{
    ...
    /** 空调制冷量 */
    @Excel(name = "空调制冷量")
    private Integer classificationOfAirRefrigerationVolume;

    /** 空调送风方式分类 */
    @Excel(name = "空调送风方式分类")
    private String classificationOfAirSupplyModes;

    /** 空调回风方式分类 */
    @Excel(name = "空调回风方式分类")
    private String classificationOfReturnAirModes;

    /** 冷源系统 */
    @Excel(name = "冷源系统")
    private String coldSourceSystem;
    ...
    /** 室外机形式 */
    @Excel(name = "室外机形式")
    private String outdoorUnitType;
    ...
    public void setClassificationOfAirRefrigerationVolume(Integer classificationOfAirRefrigerationVolume) 
    {
        this.classificationOfAirRefrigerationVolume = classificationOfAirRefrigerationVolume;
    }

    public Integer getClassificationOfAirRefrigerationVolume() 
    {
        return classificationOfAirRefrigerationVolume;
    }
    public void setClassificationOfAirSupplyModes(String classificationOfAirSupplyModes) 
    {
        this.classificationOfAirSupplyModes = classificationOfAirSupplyModes;
    }

    public String getClassificationOfAirSupplyModes() 
    {
        return classificationOfAirSupplyModes;
    }
    public void setClassificationOfReturnAirModes(String classificationOfReturnAirModes) 
    {
        this.classificationOfReturnAirModes = classificationOfReturnAirModes;
    }

    public String getClassificationOfReturnAirModes() 
    {
        return classificationOfReturnAirModes;
    }
    public void setColdSourceSystem(String coldSourceSystem) 
    {
        this.coldSourceSystem = coldSourceSystem;
    }

    public String getColdSourceSystem() 
    {
        return coldSourceSystem;
    }
    ...
    public void setNaturalCooling(String naturalCooling) 
    {
        this.naturalCooling = naturalCooling;
    }

    public String getNaturalCooling() 
    {
    ...
    public void setOutdoorUnitType(String outdoorUnitType) 
    {
        this.outdoorUnitType = outdoorUnitType;
    }

    public String getOutdoorUnitType() 
    {
        return outdoorUnitType;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("classificationOfAirRefrigerationVolume", getClassificationOfAirRefrigerationVolume())
            .append("classificationOfAirSupplyModes", getClassificationOfAirSupplyModes())
            .append("classificationOfReturnAirModes", getClassificationOfReturnAirModes())
            .append("coldSourceSystem", getColdSourceSystem())
            ...
            .append("naturalCooling", getNaturalCooling())
            .append("operationDepartment", getOperationDepartment())
            .append("outdoorUnitType", getOutdoorUnitType())
