...
/**
 * 精密配电设备对象 precision_power
 * 
 * @author ruoyi
 * @date 2021-04-18
 */
public class PrecisionPower extends BaseEntity
{
    ...
    /** 精密配电设备 */
    @Excel(name = "精密配电设备")
    private String precisionPowerDistribution;
    ...
    public void setPrecisionPowerDistribution(String precisionPowerDistribution) 
    {
        this.precisionPowerDistribution = precisionPowerDistribution;
    }

    public String getPrecisionPowerDistribution() 
    {
        return precisionPowerDistribution;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("precisionPowerDistribution", getPrecisionPowerDistribution())
