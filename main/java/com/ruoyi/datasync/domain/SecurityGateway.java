...
/**
 * 安全网关对象 security_gateway
 * 
 * @author ruoyi
 * @date 2021-04-18
 */
public class SecurityGateway extends BaseEntity
{
    ...
    /** 网关接入模式 */
    @Excel(name = "网关接入模式")
    private String netconnectionMode;
    ...
    public void setNetconnectionMode(String netconnectionMode) 
    {
        this.netconnectionMode = netconnectionMode;
    }

    public String getNetconnectionMode() 
    {
        return netconnectionMode;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("netconnectionMode", getNetconnectionMode())
