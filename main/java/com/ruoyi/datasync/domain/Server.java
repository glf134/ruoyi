...
public class Server extends BaseEntity
{
    ...
    /** CPU总个数 */
    @Excel(name = "CPU总个数")
    private Integer totalNumberOfCpu;

    /** CPU总核数 */
    @Excel(name = "CPU总核数")
    private Integer totalNumberOfCpuNuclear;
    ...
    public void setTotalNumberOfCpu(Integer totalNumberOfCpu) 
    {
        this.totalNumberOfCpu = totalNumberOfCpu;
    }

    public Integer getTotalNumberOfCpu() 
    {
        return totalNumberOfCpu;
    }
    public void setTotalNumberOfCpuNuclear(Integer totalNumberOfCpuNuclear) 
    {
        this.totalNumberOfCpuNuclear = totalNumberOfCpuNuclear;
    }

    public Integer getTotalNumberOfCpuNuclear() 
    {
        return totalNumberOfCpuNuclear;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("totalNumberOfCpu", getTotalNumberOfCpu())
            .append("totalNumberOfCpuNuclear", getTotalNumberOfCpuNuclear())
