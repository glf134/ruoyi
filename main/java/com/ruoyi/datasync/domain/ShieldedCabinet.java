...
/**
 * 屏蔽机柜对象 shielded_cabinet
 * 
 * @author ruoyi
 * @date 2021-04-18
 */
public class ShieldedCabinet extends BaseEntity
{
    ...
    /** 机柜承重 */
    @Excel(name = "机柜承重")
    private Integer cabinetBearing;
    ...
    /** 屏蔽效能 */
    @Excel(name = "屏蔽效能")
    private String shieldingEffectiven;
    ...
    public void setCabinetBearing(Integer cabinetBearing) 
    {
        this.cabinetBearing = cabinetBearing;
    }

    public Integer getCabinetBearing() 
    {
        return cabinetBearing;
    }
    ...
    public void setMaximumVolume(Integer maximumVolume) 
    {
    ...
    public void setShieldingEffectiven(String shieldingEffectiven) 
    {
        this.shieldingEffectiven = shieldingEffectiven;
    }

    public String getShieldingEffectiven() 
    {
        return shieldingEffectiven;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("cabinetBearing", getCabinetBearing())
            ...
            .append("heatDissipation", getHeatDissipation())
            ...
            .append("shieldingEffectiven", getShieldingEffectiven())
