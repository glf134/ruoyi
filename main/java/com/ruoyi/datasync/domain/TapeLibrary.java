...
public class TapeLibrary extends BaseEntity
{
    ...
    /** 磁带驱动器数量 */
    @Excel(name = "磁带驱动器数量")
    private Integer numberOfTapeDrives;
    ...
    /** 存储介质类型 */
    @Excel(name = "存储介质类型")
    private String typeOfStorageMedium;
    ...
    public void setEffectiveCapacity(Long effectiveCapacity) 
    {
    ...
    public void setNumberOfTapeDrives(Integer numberOfTapeDrives) 
    {
        this.numberOfTapeDrives = numberOfTapeDrives;
    }

    public Integer getNumberOfTapeDrives() 
    {
        return numberOfTapeDrives;
    }
    ...
    public void setTypeOfStorageMedium(String typeOfStorageMedium) 
    {
        this.typeOfStorageMedium = typeOfStorageMedium;
    }

    public String getTypeOfStorageMedium() 
    {
        return typeOfStorageMedium;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("driverIdentification", getDriverIdentification())
            .append("effectiveCapacity", getEffectiveCapacity())
            ...
            .append("numberOfTapeDrives", getNumberOfTapeDrives())
            ...
            .append("typeOfStorageMedium", getTypeOfStorageMedium())
