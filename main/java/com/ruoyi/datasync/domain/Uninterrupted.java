...
/**
 * 不间断配电对象 uninterrupted
 * 
 * @author ruoyi
 * @date 2021-04-18
 */
public class Uninterrupted extends BaseEntity
{
    ...
    /** 后备电源时长 */
    @Excel(name = "后备电源时长")
    private Integer backupPowerSupply;
    ...
    /** 额定交变频率 */
    @Excel(name = "额定交变频率")
    private Integer ratedAlternatingFrequency;

    /** 额定输入电流 */
    @Excel(name = "额定输入电流")
    private Integer ratedInputCurrent;

    /** 额定输入功率 */
    @Excel(name = "额定输入功率")
    private Integer ratedInputPower;

    /** 额定输入电压 */
    @Excel(name = "额定输入电压")
    private Integer ratedInputVoltage;

    /** 额定输出电流 */
    @Excel(name = "额定输出电流")
    private Integer ratedOutputCurrent;
    ...
    /** 额定输出电压 */
    @Excel(name = "额定输出电压")
    private Integer ratedOutputVoltage;
    ...
    /** 不间断电源主机功率模块类型 */
    @Excel(name = "不间断电源主机功率模块类型")
    private String typeOfUninterruptibleMainsPowerModule;

    /** 不间断电源主机类型 */
    @Excel(name = "不间断电源主机类型")
    private String uninterruptibleMainsType;

    /** 不间断电源并机系统 */
    @Excel(name = "不间断电源并机系统")
    private String upsParallelSystem;
    ...
    public void setBackupPowerSupply(Integer backupPowerSupply) 
    {
        this.backupPowerSupply = backupPowerSupply;
    }

    public Integer getBackupPowerSupply() 
    {
        return backupPowerSupply;
    }
    ...
    public void setRatedAlternatingFrequency(Integer ratedAlternatingFrequency) 
    {
        this.ratedAlternatingFrequency = ratedAlternatingFrequency;
    }

    public Integer getRatedAlternatingFrequency() 
    {
        return ratedAlternatingFrequency;
    }
    public void setRatedInputCurrent(Integer ratedInputCurrent) 
    {
        this.ratedInputCurrent = ratedInputCurrent;
    }

    public Integer getRatedInputCurrent() 
    {
        return ratedInputCurrent;
    }
    public void setRatedInputPower(Integer ratedInputPower) 
    {
        this.ratedInputPower = ratedInputPower;
    }

    public Integer getRatedInputPower() 
    {
        return ratedInputPower;
    }
    public void setRatedInputVoltage(Integer ratedInputVoltage) 
    {
        this.ratedInputVoltage = ratedInputVoltage;
    }

    public Integer getRatedInputVoltage() 
    {
        return ratedInputVoltage;
    }
    public void setRatedOutputCurrent(Integer ratedOutputCurrent) 
    {
        this.ratedOutputCurrent = ratedOutputCurrent;
    }

    public Integer getRatedOutputCurrent() 
    {
    ...
    public Integer getRatedOutputPower() 
    {
        return ratedOutputPower;
    }
    public void setRatedOutputVoltage(Integer ratedOutputVoltage) 
    {
        this.ratedOutputVoltage = ratedOutputVoltage;
    }

    public Integer getRatedOutputVoltage() 
    {
    ...
    public void setTypeOfUninterruptibleMainsPowerModule(String typeOfUninterruptibleMainsPowerModule) 
    {
        this.typeOfUninterruptibleMainsPowerModule = typeOfUninterruptibleMainsPowerModule;
    }

    public String getTypeOfUninterruptibleMainsPowerModule() 
    {
        return typeOfUninterruptibleMainsPowerModule;
    }
    public void setUninterruptibleMainsType(String uninterruptibleMainsType) 
    {
        this.uninterruptibleMainsType = uninterruptibleMainsType;
    }

    public String getUninterruptibleMainsType() 
    {
        return uninterruptibleMainsType;
    }
    public void setUpsParallelSystem(String upsParallelSystem) 
    {
        this.upsParallelSystem = upsParallelSystem;
    }

    public String getUpsParallelSystem() 
    {
        return upsParallelSystem;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("backupPowerSupply", getBackupPowerSupply())
            ...
            .append("numberOfBatteries", getNumberOfBatteries())
            .append("operationDepartment", getOperationDepartment())
            .append("ratedAlternatingFrequency", getRatedAlternatingFrequency())
            .append("ratedInputCurrent", getRatedInputCurrent())
            .append("ratedInputPower", getRatedInputPower())
            .append("ratedInputVoltage", getRatedInputVoltage())
            .append("ratedOutputCurrent", getRatedOutputCurrent())
            .append("ratedOutputPower", getRatedOutputPower())
            .append("ratedOutputVoltage", getRatedOutputVoltage())
            ...
            .append("typeOfUninterruptibleMainsPowerModule", getTypeOfUninterruptibleMainsPowerModule())
            .append("uninterruptibleMainsType", getUninterruptibleMainsType())
            .append("upsParallelSystem", getUpsParallelSystem())
