...
/**
 * 视频监控类对象 video_monitoring
 * 
 * @author ruoyi
 * @date 2021-04-18
 */
public class VideoMonitoring extends BaseEntity
{
    ...
    /** 监控摄像头数量 */
    @Excel(name = "监控摄像头数量")
    private Integer surveillanceNumber;
    ...
    public void setDataSavePeriod(String dataSavePeriod) 
    {
        this.dataSavePeriod = dataSavePeriod;
    }

    public String getDataSavePeriod() 
    {
    ...
    public void setMonitoringScope(String monitoringScope) 
    {
    ...
    public void setSurveillanceNumber(Integer surveillanceNumber) 
    {
        this.surveillanceNumber = surveillanceNumber;
    }

    public Integer getSurveillanceNumber() 
    {
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("dataSavePeriod", getDataSavePeriod())
            ...
            .append("monitoringScope", getMonitoringScope())
            ...
            .append("surveillanceNumber", getSurveillanceNumber())
