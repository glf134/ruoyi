 ...
 * @date 2021-04-18
 */
public class Vpn extends BaseEntity
{
    ...
    /** 隧道数 */
    @Excel(name = "隧道数")
    private Integer numberOfTunnels;
    ...
    /** 是否支持国密算法 */
    @Excel(name = "是否支持国密算法")
    private String stateSecretSupported;
    ...
    public void setNumberOfTunnels(Integer numberOfTunnels) 
    {
        this.numberOfTunnels = numberOfTunnels;
    }

    public Integer getNumberOfTunnels() 
    {
    ...
    public void setStateSecretSupported(String stateSecretSupported) 
    {
        this.stateSecretSupported = stateSecretSupported;
    }

    public String getStateSecretSupported() 
    {
        return stateSecretSupported;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("digitalDigest", getDigitalDigest())
            ...
            .append("maximumConnections", getMaximumConnections())
            .append("numberOfTunnels", getNumberOfTunnels())
            ...
            .append("protocolSupported", getProtocolSupported())
            ...
            .append("stateSecretSupported", getStateSecretSupported())
