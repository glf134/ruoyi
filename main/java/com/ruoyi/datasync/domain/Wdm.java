 ...
 * @date 2021-04-18
 */
public class Wdm extends BaseEntity
{
    ...
    /** 光通路数 */
    @Excel(name = "光通路数")
    private String numberOfFibreChannel;
    ...
    public void setNumberOfFibreChannel(String numberOfFibreChannel) 
    {
        this.numberOfFibreChannel = numberOfFibreChannel;
    }

    public String getNumberOfFibreChannel() 
    {
        return numberOfFibreChannel;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("numberOfFibreChannel", getNumberOfFibreChannel())
            ...
            .append("wavelengthRange", getWavelengthRange())
